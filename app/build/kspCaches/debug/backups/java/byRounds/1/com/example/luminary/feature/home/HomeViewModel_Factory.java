...
public final class HomeViewModel_Factory implements Factory<HomeViewModel> {
  ...
  public HomeViewModel_Factory(Provider<ArticleRepository> repositoryProvider) {
  ...
  public static HomeViewModel_Factory create(Provider<ArticleRepository> repositoryProvider) {
    return new HomeViewModel_Factory(repositoryProvider);
  }

  public static HomeViewModel newInstance(ArticleRepository repository) {
